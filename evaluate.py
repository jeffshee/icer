...
def main():
    ...
    in_fpath = './output_exp12_uis_rnn_30sec_loudness_1.0_0.5/transcript.csv'
    transcription_list = separete_text(in_fpath)

    in_fpath = './output_exp12_uis_rnn_30sec_loudness_1.0_0.5/200221 expt12 video_GT_reshaped.csv'
    answer_list = separete_text(in_fpath)
